...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\PC\django_projects\second-django-project\val'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\PC\django_projects\second-django-project\val\Scripts\deactivate.nu'
